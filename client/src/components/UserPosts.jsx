...
function UserPosts() {
    ...
    const handleDelete = async (postId) => {
        ...
        try {
            ...
            await axios.delete(`https://devlance-veiu.onrender.com/api/post/delete/${postId}`, {
    ...
    const handleEdit = async (postId) => {
        try {
            // Replace with your axios call:
            await axios.put(
                `https://devlance-veiu.onrender.com/api/post/edit/${postId}`,
                { blog: editedContent },
                { withCredentials: true }
            );
    ...
    const fetchPosts = async () => {
        try {
            setLoading(true);
            // Replace with your axios call:
            const res = await axios.get("https://devlance-veiu.onrender.com/api/post/userpost", { 
                withCredentials: true 
            });
